...
class CategorieVoter extends Voter
{
    ...
    const VOIR_INDEX = 'categorie_index';
    const CREER = 'categorie_creer';
    const VOIR = 'categorie_voir';
    const SUPPRIMER = 'categorie_supprimer';
    const MODIFIER = 'categorie_modifier';
    ...
    protected function supports($attribute, $subject): bool
    {
        ...
        if ($subject && !$subject instanceof Categorie) {
            return false;
        }
    ...
    {
        if ($this->security->isGranted('ROLE_ADMIN') || $this->security->isGranted('ROLE_PROFESSEUR')) {
            return true;
        }
