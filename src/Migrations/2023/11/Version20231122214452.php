 ...
 */
final class Version20231122214452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_B6BD307FABA4CF8E ON message (expediteur)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B6BD307FABA4CF8E ON message');
    }
}
