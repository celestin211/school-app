...
class ScheduleController extends AbstractController
{
     ...
     */
    public function index(ScheduleRepository $scheduleRepository, RendezVousRepositoryt $appointmentRepository, UtilisateurRepository $utilisateurRepository): Response
    {
        $now = new DateTime();

        $user = $this->getUser()->getUsername();

        $iduser = $utilisateurRepository->findIdByUsername($user);
