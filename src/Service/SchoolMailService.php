...
class SchoolMailService
{
    ...
    {
        $subject = 'SIGNSCHOOLAC : Campagne "'.$liste->getCampagne()->getTypeCampagneImpression()."\" : Dévalidation des fiches d'intégration du Ministère ".$liste->getMinistere()->getLibelleCourt();
